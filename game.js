...
Game = {
  ...
  Runner: {
    ...
    addEvents: function () {
      ...
      //Game.addEvent(document, 'keypress', this.onkeypress.bind(this));
      Game.addEvent(document, 'keyup', this.onkeyup.bind(this));
    },

    onkeypress: function () {
      if (this.game.onkeypress) {
        Object.values(this.active_keys).forEach(keyCode => {
          this.game.onkeypress(keyCode);
        })
      }
    },
    onkeydown: function (ev) {
      if (this.game.onkeydown && !this.active_keys[ev.keyCode]) this.game.onkeydown(ev.keyCode);
      this.active_keys[ev.keyCode] = ev.keyCode;
    },
    onkeyup: function (ev) {
      delete this.active_keys[ev.keyCode];
